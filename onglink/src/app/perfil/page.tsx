    ...
    <>
        ...
        <div className="container-fluid">
          <img id="fundo_perfil" src="https://images.pexels.com/photos/957024/forest-trees-perspective-bright-957024.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"></img>
            <div className="card-body bg-success-subtle p-3 pt-3">
                <div>
                  <div id="titulo_perfil">

                    <div className="img-overlay-wrap">
                    <Image id="logo_MUXN" className="avatar-img rounded-circle border d-inline"src={MuxnLogo1} alt="logo_muxn" width={150} height={100}/>
                    ...
                    <div id="div_nome_perfil"><h3>MUXN</h3>
                    <p>Projetos Sociais</p></div>
            ...
            <div id="subdiv_post2" className="w-50">
